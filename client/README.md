...
with rai_api.ApiClient(configuration) as api_client:
...
If the OpenAPI document is large, imports in rai_api.apis and rai_api.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from rai_api.api.default_api import DefaultApi`
- `from rai_api.model.pet import Pet`
