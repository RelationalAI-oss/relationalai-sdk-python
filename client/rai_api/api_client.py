...
from rai_api import rest
from rai_api.configuration import Configuration
from rai_api.exceptions import ApiTypeError, ApiValueError, ApiException
from rai_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.transaction_post  # this is an instance of the class Endpoint
        api_instance.transaction_post()  # this invokes api_instance.transaction_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.transaction_post.callable or self.callable in this class
